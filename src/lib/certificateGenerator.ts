...
const RANK_DESIGNS: Record<string, RankDesign> = {
  ...
  Sapphire: {
    ...
    borderColor: "#3b82f6",
    cornerColor: "#3b82f6",
    subtitleText: "Of Sustained Excellence",
    rankIcon: "🔷",
    flourishColor: "#3b82f6",
  },
  Icon: {
    theme: "royal",
    bgGradientFrom: "#0d0517",
    bgGradientTo: "#1a0a1f",
    accentPrimary: "#ffd700",
    accentSecondary: "#fff8dc",
    accentGlow: "#ffb800",
    textTitle: "#ffd700",
    textSubtitle: "#fff8dc",
    textBody: "#fef9e7",
    ...
    borderColor: "#ffd700",
    cornerColor: "#ffd700",
    subtitleText: "Of Legendary Distinction",
    rankIcon: "⭐",
    flourishColor: "#ffd700",
  },
  Earning: {
    theme: "ivory",
    bgGradientFrom: "#faf9f6",
    ...
    borderColor: "#1e3a5f",
    cornerColor: "#1e3a5f",
    subtitleText: "Of Consistent Achievement",
    rankIcon: "",
    flourishColor: "#1e3a5f",
  },
};
